...
CREATE TABLE `account` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='User accounts';
...
INSERT INTO `post` VALUES (1,1,'title','body',NULL,'2024-11-13 15:46:40'),(2,1,'title','body',NULL,'2024-11-13 16:07:33'),(3,1,'test2','test',NULL,'2024-11-13 16:11:53'),(4,1,'test3','body #rgsgrfs \ngj#ter',NULL,'2024-11-13 16:17:14');
...
-- Dump completed on 2024-11-18 21:28:11
